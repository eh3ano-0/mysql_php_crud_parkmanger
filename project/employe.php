...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    if ($_POST['action'] == "add_employee") {
        ...
        try {
            ...
            $stmt->bind_param("ssds", $id, $position, $salary, $datehir);
            $stmt->execute();
...
<body>
        ...
        <form method="POST" action="">
            ...
            <select name="id" required>
                ...
                <option value="<?php echo $person['person_id']; ?>">
                    <?php echo "کدملی: ".$person['person_id']. " - اسم:".$person['first_name'] . " " . $person['last_name']." - نام پدر: ".$person['name_father']." - شماره:".$person['phone'] . " - " . $person['email']; ?>
                </option>
                <?php endforeach; ?>
            </select>
            <input type="text" name="position" placeholder="سمت" required>
            <input type="number" name="salary" placeholder="حقوق" required>
            <input type="Date" name="datehir" placeholder="تاریخ استخدام" required>
    ...
    <div class="modal" id="edit-modal">
        ...
        <form method="POST" action="">
            ...
            <input type="Date" name="datehir" id="edit-datehir" placeholder="تاریخ استخدام" required>
